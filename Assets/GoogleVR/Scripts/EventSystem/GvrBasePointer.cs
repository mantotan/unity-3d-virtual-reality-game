...
public abstract class GvrBasePointer {
  ...
  public virtual bool TriggerDown {
    get {
      bool isTriggerDown = Input.GetMouseButtonDown(0) || Input.GetKeyDown(KeyCode.Joystick1Button2);
  ...
  public virtual bool Triggering {
    get {
      bool isTriggering = Input.GetMouseButton(0) || Input.GetKeyDown(KeyCode.Joystick1Button2);
#if UNITY_HAS_GOOGLEVR && (UNITY_ANDROID || UNITY_EDITOR)
